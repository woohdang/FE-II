...
window.addEventListener('load', function () {
  ...
  const urlTareas = 'https://ctd-todo-api.herokuapp.com/v1/tasks'; // <---  IMPORTANTE: CAMBIAR POR LA URL DE LA API
  const urlUsuario = 'https://ctd-todo-api.herokuapp.com/v1/users/getMe'; // <---  IMPORTANTE: CAMBIAR POR LA URL DE LA API
  ...
  /******************************************************************************/
  /********************** [2] - Obtener nombre de usuario [GET]  ****************/
  /******************************************************************************/
  ...
  /******************************************************************************/
  /*****************  [3] - Obtener listado de tareas [GET]  ********************/
  /******************************************************************************/
  ...
  /******************************************************************************/
  /******************** [5] - Renderizar tareas en pantalla *********************/
  /******************************************************************************/
